...
class Graph(Generic[V]):
    ...
    #add vertex in graph and return his index
    def add_vertex(self, vertex: V) -> int:
        self._verticies.append(vertex)
        self._edges.append([])
    ...
    def add_edge_by_indicies(self, u: int, v: int) -> None:
        edge: Edge = Edge(u, v)
        self.add_edge(edge)
...
if __name__ == "__main__":
    ...
    #print(city_graph)
    bfs_result: Optional[None[V]] = breadth_first_search('Boston', lambda x: x == "Miami", city_graph.neighbors_for_vertex)
    if bfs_result is None:
        print('No solution found =()')
    else:
        path: List[V] = node_to_path(breadth_first_search)
