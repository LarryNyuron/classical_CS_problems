...
class SMM2(Chromosome):
    ...
    @classmethod
    def random_instance(cls) -> SMM2:
        letters = ['S', 'E', 'N', 'D', 'M', 'O', 'R', 'Y', ' ', ' ']
        shuffle(letters)
        return SMM2(letters)

    def crossover(self, other: SMM2) -> Tuple[SMM2, SMM2]:
        child1: SMM2 = deepcopy(self)
        child2: SMM2 = deepcopy(other)
...
if __name__ == "__main__":
    initial_population: List[SMM2] = [SMM2.random_instance() for _ in range(1000)]
    ga: GeneticAlgorithm[SMM2] = GeneticAlgorithm(initial_population=initial_population, threshold=1.0, \
